...
bsdf = pd.read_csv('c:/xampp/htdocs/python/bsTestETLDQLabLagi/bs-participants.csv')
...
bsdf.to_csv('c:/xampp/htdocs/python/bsTestETLDQLabLagi/bs-participants.csv', index=False)
